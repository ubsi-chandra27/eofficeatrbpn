...
<div class="employee-card fade-up">
    <form method="GET" class="employee-filter">
        <div class="employee-search"><i class="bi bi-search"></i><input name="keyword" value="{{ request('keyword') }}" placeholder="Cari nama, NIP, NIPP, email, atau nomor HP"></div>
    ...
    <div class="table-responsive">
        <table class="table employee-table align-middle mb-0">
            <thead><tr><th>No</th><th>Pegawai</th><th>NIPP</th><th>Kontak</th><th>Jabatan &amp; Unit</th><th>Status Akun</th><th class="text-end">Aksi</th></tr></thead>
            <tbody>
            @forelse($pegawai as $item)
                <tr>
                    ...
                    <td><span class="nipp-chip">{{ $item->nipp ?: 'Belum diisi' }}</span></td>
            ...
            @empty
                <tr><td colspan="7"><div class="employee-empty"><i class="bi bi-person-x"></i><h5>Data pegawai tidak ditemukan</h5><p>Ubah filter pencarian atau tambahkan pegawai baru.</p></div></td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
