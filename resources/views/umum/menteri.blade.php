...
<div class="public-info-detail public-detail-shell">
    ...
    <section class="biography-panel">
        ...
        <div class="biography-body">
            <p>Nusron Wahid, S.S., M.Si. merupakan seorang tokoh yang memiliki latar belakang kuat di bidang politik, agama, dan organisasi kemasyarakatan. Ia memulai mimpi besarnya untuk membangun Indonesia dari sebuah daerah yang disebut sebagai Kota Santri, yaitu Kabupaten Kudus, Jawa Tengah.</p>
            <p>Lahir pada tanggal 12 Oktober 1973, ia menempuh pendidikan dasar hingga menengah di Kabupaten Kudus dan melanjutkan pendidikan tingginya di Fakultas Ilmu Budaya, Universitas Indonesia. Dalam masa perkuliahannya, ia aktif dalam berbagai organisasi, di antaranya Senat Mahasiswa, serta menjadi Ketua Majalah Kampus Suara Mahasiswa UI dan turut mendirikan Forum Ilmiah Kajian Islam. Nusron kemudian melanjutkan pendidikan pascasarjana di Fakultas Ekonomi dan Manajemen, Institut Pertanian Bogor, dan mendapatkan gelar Magister pada tahun 2011.</p>
            <p>Nusron memulai kariernya di bidang politik pada tahun 2004. Ia dipilih oleh rakyat untuk mengemban amanah sebagai Anggota DPR RI dari Partai Golongan Karya. Melalui Komisi VI, ia mengawasi berbagai kebijakan yang berhubungan dengan perdagangan, perindustrian, investasi, koperasi, UKM, BUMN, dan Standardisasi Nasional.</p>
            <p>Pada tahun 2014 hingga 2019, Nusron menjabat sebagai Kepala Badan Nasional Penempatan dan Perlindungan Tenaga Kerja Indonesia (BNP2TKI). Melalui BNP2TKI, ia mengelola tenaga kerja Indonesia (TKI) yang bekerja di luar negeri dengan melaksanakan kebijakan perlindungan dan penempatan para TKI.</p>
            <p>Berkat upaya dan dedikasinya dalam memperjuangkan hak-hak rakyat, Nusron ditetapkan menjadi Ketua Pansus DPR RI terkait Penyelenggaraan Haji Tahun 2024. Ia secara tegas memberikan rekomendasi untuk dilakukan revisi terhadap UU Nomor 8 Tahun 2019 tentang Penyelenggaraan Ibadah Haji dan Umrah serta UU Nomor 34 Tahun 2014 tentang Pengelolaan Keuangan Haji.</p>
            <p>Nusron memiliki pengalaman yang luas pada organisasi keagamaan. Tahun 2011&ndash;2016, ia pernah menjabat sebagai Ketua Umum Gerakan Pemuda Ansor, organisasi pemuda di bawah naungan organisasi agama Islam di Indonesia, yaitu Nahdlatul Ulama (NU). Kemudian pada tahun 2022&ndash;2024, ia menjabat sebagai Wakil Ketua Umum Pengurus Besar Nahdlatul Ulama (PBNU).</p>
            <p>Kini, Nusron Wahid dipercaya oleh Presiden Prabowo Subianto menjadi Menteri Agraria dan Tata Ruang (ATR)/Kepala Badan Pertanahan Nasional (BPN) setelah dilantik pada 21 Oktober 2024.</p>
        </div>
    </section>
